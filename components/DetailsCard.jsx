    ...
    <div className="card bg-base-100 shadow-sm w-full sm:w-80 md:w-96">
        ...
        {isHovered && (
          <div className="absolute inset-0 flex flex-row items-center justify-center gap-3 bg-black/50 transition-opacity">
            <button className="flex items-center gap-2 px-4 py-2 bg-[#0B6BC4] text-white font-bold text-xs rounded shadow-lg hover:bg-[#e66a00]">
              Book Now <FontAwesomeIcon icon={faArrowRight} className="w-4 h-4" />
            </button>
            <button className="flex items-center gap-2 px-4 py-2 bg-[#0B6BC4] text-white font-bold text-xs rounded shadow-lg hover:bg-white hover:text-[#0B6BC4]">
              Quick Enquiry <FontAwesomeIcon icon={faArrowRight} className="w-4 h-4" />
            </button>
          </div>
        )}
      </figure>
      ...
      <div className="card-body p-4">
        <h2 className="text-sm font-bold text-[#0A2540] flex items-center gap-2">
          ...
          <span className="text-[#828282] text-[10px] font-medium">18 Days</span>
        </h2>

        {/* Rating Section */}
        <div className="flex items-center mt-1">
          <div className="rating rating-sm">
            <input type="radio" name="rating-9" className="mask mask-star-2 bg-[#FF7902]" />
            <input type="radio" name="rating-9" className="mask mask-star-2 bg-[#FF7902]" defaultChecked />
            <input type="radio" name="rating-9" className="mask mask-star-2 bg-[#FF7902]" />
            <input type="radio" name="rating-9" className="mask mask-star-2 bg-[#FF7902]" />
            <input type="radio" name="rating-9" className="mask mask-star-2 bg-[#FF7902]" />
          </div>
          <span className="text-[#828282] text-[10px] font-medium ml-4">17 Reviews</span>
        </div>
        ...
        <div className="flex justify-between items-center gap-6 md:gap-0 mt-3">
          <div className="flex items-center gap-2 w-1/2 sm:w-auto">
            ...
            <div>
              <h3 className="text-xs text-[#0A2540] font-semibold">Destination</h3>
              <h3 className="text-xs text-[#0A2540] font-medium">MultiCountry</h3>
            </div>
          </div>
          <div className="flex items-center gap-2 w-1/2 sm:w-auto">
            <BsGraphUpArrow className="text-2xl" />
            <div>
              <h3 className="text-xs text-[#0A2540] font-semibold">Difficulty</h3>
              <h3 className="text-xs text-[#0A2540] font-medium">Challenging</h3>
            </div>
          </div>
      ...
      <div className="flex items-center justify-between mt-3 h-14 bg-[#F0F0F0] w-full">
        <div className="text-sm text-[#0A2540] font-semibold ml-5">
          <p>
            ...
            <span className="text-sm text-[#0A2540] font-semibold">1700 / permax</span>
          </p>
        </div>
        <div
