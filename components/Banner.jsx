  ...
  return (
    <div className="relative flex h-screen items-center justify-center text-white">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-3xl mx-auto">
        ...
        <p className="text-xs sm:text-sm md:text-base mb-8 sm:mb-12 max-w-xl mx-auto">
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Rem
          dignissimos, earum reiciendis ex asperiores, quaerat odio odit eaque
          ducimus numquam corrupti
        </p>

        <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto bg-white rounded-lg shadow-md">
          <FaSearch className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm sm:text-base" />
          <input
            type="text"
            placeholder="Enter your keywords..."
            className="w-full rounded-lg border-none px-10 py-2 sm:py-3 text-black text-sm sm:text-base placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FF7902]"
          />
        </div>
      </div>

      {/* Bottom Left Section */}
      <div className="absolute bottom-4 sm:bottom-5 left-2 sm:left-4 md:left-10 bg-[#0B6BC4] text-white flex items-center px-2 sm:px-3 py-1 sm:py-2 gap-1 sm:gap-2 rounded-lg">
        <FaPlayCircle className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5" />
